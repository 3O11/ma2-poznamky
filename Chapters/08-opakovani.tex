...
\begin{figure}[h]
	\centering
	\subfloat[Dolní Riemannova suma]{{\includegraphics[width=4.5cm]{08-lsum} }}%
	\hspace{3em}
	\subfloat[Horní Riemannova suma]{{\includegraphics[width=4.5cm]{08-usum} }}%
	\hspace{3em}
	\subfloat[Integrál funkce]{{\includegraphics[width=4.5cm]{08-integral} }}%

...
\begin{figure}[h]
	...
	\caption{Geometrický význam parciální derivace funkce.}%
	\label{fig:par}
\end{figure}

\subsection{Totální diferenciál}
Nespojitá funkce $f$ může mít po souřadnicích všechny parciální derivace v každém bodě, to však ale neimplikuje spojitost. \textbf{Existence parciálních derivací neimplikuje spojitost!}
...
\subsubsection{Globální extrémy}
...
\begin{definition}[Konvexní podmnožina]

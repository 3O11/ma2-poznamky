...
\begin{figure}[h]
	\centering
	\subfloat[\centering Cauchyovská posloupnost]{{\includegraphics[width=6cm]{03-cauchy-1} }}%
	\hspace{5em}
	\subfloat[\centering Necauchyovská posloupnost]{{\includegraphics[width=6cm]{03-cauchy-2} }}%

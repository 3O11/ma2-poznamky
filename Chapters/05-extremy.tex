...
\begin{intuition}
	...
	Funkce splňuje předpoklady věty o hledání extrému funkcí a má tedy Lagrangeovy multiplikátory.
	...
	Jejich vyřešením (3 rovnice, 3 proměnné) dostáváme \(\left(\frac{2}{\sqrt{5}}, \frac{1}{\sqrt{5}}\right)\) a \(\left(\frac{-2}{\sqrt{5}}, \frac{-1}{\sqrt{5}}\right)\) (viz obrázek \ref{fig:lagex}).
